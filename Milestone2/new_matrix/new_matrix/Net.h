...
{
    public:
        Net(unsigned int input_size, vector<unsigned int> hidden_size_list, unsigned int output_size, string mode, bool dropout_train);
        ...
        vector<vector<double> > random_weight(unsigned int currentlayer_size, unsigned int nextlayer_size); //randomize weight
        vector<double> random_bias(unsigned int currentlayer_size); //randomize bias
